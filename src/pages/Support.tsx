...
const faqItems = [
  {
    ...
    answer:
      "Перейдите в раздел 'Топливные карты' и нажмите кнопку 'Добавить карту'. Заполните необходимые данные и сохраните изменения.",
  },
  {
    question: "Как сформировать отчет по расходам?",
    answer:
      "В разделе 'Отчетность' выберите период, тип отчета и нажмите 'Сформировать'. Отчет будет доступен для скачивания в формате PDF или Excel.",
  },
  {
    question: "Что делать при потере карты?",
    answer:
      "Немедленно свяжитесь с нашей службой поддержки по телефону или электронной почте для блокировки карты.",
  },
];
